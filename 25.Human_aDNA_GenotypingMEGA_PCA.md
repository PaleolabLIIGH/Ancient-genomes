Written by Xavier Roca Rada

NOTE: This is the script of Viri modified
...
plink --merge-list merging_list.txt --recode --out HSJN_CON_genotypes --allow-no-sex --keep-allele-order
...
plink --merge-list merging_list2.txt --recode --out $REFERENCE_NAME.HSJN_CON_genotypes --allow-no-sex --keep-allele-order
